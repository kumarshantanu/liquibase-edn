...
public abstract class AbstractMapChangeLogParser implements ChangeLogParser {
    ...
    public DatabaseChangeLog parse(String physicalChangeLogLocation, ChangeLogParameters changeLogParameters,
        ...
        try {
            final InputStream changeLogStream = resourceAccessor.getResourceAsStream(physicalChangeLogLocation);
            final Map<String, ?> map = parseAsMap(changeLogStream);
            changeLogStream.close();
            return parse(map, physicalChangeLogLocation, changeLogParameters, resourceAccessor);
        } catch(Exception e) {
            throw new ChangeLogParseException(e);
        }
    }

    public DatabaseChangeLog parse(Map<String, ?> changeLogAsMap, String physicalChangeLogLocation,
